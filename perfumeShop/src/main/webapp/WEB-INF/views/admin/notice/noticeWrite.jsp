					...
					<form role="form" method="post" >
						<div class="flex flex-wrap -mx-3 mb-2">
							<div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
								<label class="block uppercase tracking-wide text-grey-darker text-xs font-light mb-1">&nbsp;제목</label> 
									...
									type="text" id="nTitle" name="nTitle" placeholder="제목을 작성하세요">
							</div>
							<div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
								<label class="block uppercase tracking-wide text-grey-darker text-xs font-light mb-1">작성자</label>
								<input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-grey"
									type="text" name="mUserName" placeholder="관리자" value="${member.mUserName}" disabled>
							</div>
						</div>
						<hr />
						<div class="w-full md:w-3/3 px-0 mb-10 md:mb-100">
							...
							<textarea class = "ckeditor" id="nContent" name="nContent" rows="5" cols="50" ></textarea>
						</div>
						<hr />
						<div>
