						...
						<div class="col-lg-6 col-md-6">
							<div class="login_part_form">
									<div class="text-center">
                                        <h4 style="font-family: 'Noto Serif KR', serif; font-weight:bold;">아이디 찾기</h4>
										<a style="font-family: 'Noto Serif KR', serif;">이메일을 입력해주세요!</a>
                                    </div>
                                    <br>
                                   <form action="/member/findId" method="POST">
                                       <div class="form-group">
                                           <input type="email" class="form-control form-control-user" name="mUserEmail" id="mUserEmail" placeholder="이메일을 입력해주세요.." style="font-family: 'Noto Serif KR', serif;">
                                       </div>
                                       	<button type="submit" id="submit" class="btn btn-primary btn-user btn-block">Find ID</button>
                                   </form>
                                     <hr>
                                   	<a href="/member/signin" style="font-family: 'Noto Serif KR', serif;" class="btn btn-facebook btn-user btn-block">Login</a>
                                     <hr>
                                       <a href="/member/findPwView" style="font-family: 'Noto Serif KR', serif;" class="btn btn-facebook btn-user btn-block">비밀번호 찾기</a>
								</div>
							</div>
					<hr />
			</div>
