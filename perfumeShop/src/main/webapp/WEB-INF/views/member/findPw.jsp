...
<body>
	...
	<main>
		...
		<div class="container" align="center" style="height: auto; widows: 1000px;">
				...
				<hr />
				<div class="o-hidden shadow-lg my-6">
					<div class="jumbotron">
						<h2 style="font-family: 'Noto Serif KR', serif;">임시 비밀번호가 전송되었습니다.</h2>
						<br />
							<h1 style="font-family: 'Noto Serif KR', serif; font-weight:bold;">${find}</h1>
						<br />
							<h5 style="font-family: 'Noto Serif KR', serif;">이메일을 확인해주세요.</h5>
						<br><hr><br>
						...
						<button type="button" class="btn btn-primary" onclick="location.href='/member/findIdView'" style="font-family: 'Noto Serif KR', serif;">아이디 찾기</button>
					</div>
					<hr />
				</div>
				<hr />
