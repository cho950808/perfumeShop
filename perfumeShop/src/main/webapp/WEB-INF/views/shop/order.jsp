               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="hero-cap text-center text-bold">
                        <h2 style="font-family: 'Noto Serif KR', serif;">주문 (결제)</h2>
                     </div>
                  </div>
               </div>
            </div>
          ...
          <div class="cart_inner">
            <div class="table-responsive">
              <table class="table">
                ...
                <c:forEach items="${order}" var="cartList">
                  <tr align="center">
          ...
          <div class="orderInfo" align="left">
				<form role="form" method="post" autocomplete="off">
					...
					<div class="inputArea" align="right">
						<button type="submit" class="order_btn btn-primary" style="font-family: 'Noto Serif KR', serif;">주문</button>
						<button type="button" class="cancel_btn btn-secondary" style="font-family: 'Noto Serif KR', serif;">취소</button>
					</div>
				</form>	
			</div>
          </table>
